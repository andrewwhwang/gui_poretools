...
@Gooey(default_size=(750, 750),program_name='Poretools')
def main():
    logging.basicConfig()
    ...
    #########################################
    parser = GooeyParser(prog='poretools', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    parser.add_argument("-v", "--version", help="Installed poretools version",
                        action="version",
                        version="%(prog)s " + str(poretools.version.__version__))
    subparsers = parser.add_subparsers(dest='command')#, parser_class=ArgumentParserWithDefaults)
    ...
    parser_combine.add_argument('files', metavar='FILES', nargs='+',
                             help='The input FAST5 files.', widget="DirChooser")
    ...
    parser_fastq.add_argument('files', metavar='Fast5 directory', nargs='+',
                             help='The input FAST5 files.', widget="DirChooser")
    parser_fastq.add_argument('out_file',
                            metavar='Output File',
                            help='Where to output the fastq file',
                            widget="FileSaver")
    parser_fastq.add_argument('--type',
                              dest='type',
                              metavar='type_of_reads',
    ...
    parser_fasta.add_argument('files', metavar='Fast5 directory', nargs='+',
                             help='The input FAST5 files.', widget="DirChooser")
    parser_fasta.add_argument('out_file',
                              metavar='Output File',
                              help='Where to output the fasta file',
                              widget="FileSaver")
    ...
    parser_qualpos.add_argument('--saveas',
                             dest='saveas',
                             metavar='saveas (e.g. pdf, jpg)',
                             help='Save the plot to a file named filename',
                             default=None,
                             widget='FileSaver')
    ...
    parser_times.add_argument('files', metavar='FILES', nargs='+',
                               help='The input FAST5 files.', widget="DirChooser")
    parser_times.add_argument('out_file',
                            metavar='Output File',
                            help='Where to output the txt file',
                            widget="FileSaver")
    ...
    parser_organise.add_argument('dest',
                               ...
                               help='The destination directory.', widget="DirChooser")
